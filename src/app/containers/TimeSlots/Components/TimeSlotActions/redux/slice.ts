...
import { TimeSlotsActionsListItemType, UserState } from "../types";
...
export const TimeSlotActionListSlice = createSlice({
  ...
  initialState,
  reducers: {
    editUser: (state, action: PayloadAction<TimeSlotsActionsListItemType>) => {
    ...
    handleBlockSuccess: (state, action: PayloadAction<TimeSlotsActionsListItemType>) => {
      // const index = state.list.items.findIndex(
