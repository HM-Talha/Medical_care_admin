...
const PatientsDetailsEditAssign = () => {
  ...
  const [tableData, setTableData] = useState({
    ...
    bankName: "Hours Bank # 1",
    assignedAdvisor: "Assigned Advisor",
    patientFirstName: "Enter Your First Name",
    patientLastName: "Enter Your Last Name",
  });
  ...
  console.log("table Data", tableData.organizationName);
    ...
    <div className={styles.parent}>
      ...
      <div className={styles.right}>
        ...
        <section>
          ...
          >
            <thead>
              <tr className={styles.trHead}>
                ...
                <td className={styles.tdHeader}>Treatment Date & Time</td>
                ...
                return (
                  <tr className={styles.tr}>
                    <td className={styles.actionTD}>
                      <SendIcon
                        style={{ color: "#FA7344", fontSize: "19px" }}
                      />
                      <DeleteIcon
                        style={{
                          color: "#C66078",
          ...
          <div
            className={styles.bottomBoxParent}
              ...
              <table className={styles.modal_table}>
                <thead>
                  <tr>
                    ...
                    <td className={styles.modal_table_header}>Individual</td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              >
                <div className={styles.modal_dropDown}>
                  ...
                  <Select
                    ...
                    open={excelBankOpen}
                    IconComponent={KeyboardArrowDownIcon}
                    style={{ background: "#fff", width: "192px" }}
                  >
                    <MenuItem
                      onClick={() => setExcelBankOpen(!excelBankOpen)}
                      value={10}
                ...
                >
                  ...
                  <Select
                    ...
                    open={treatment}
                    IconComponent={KeyboardArrowDownIcon}
                    style={{ background: "#fff", width: "236px" }}
                  >
                    <MenuItem
                      onClick={() => setTreatment(!treatment)}
                      value={10}
                ...
                >
                  ...
                  <Select
                    ...
                    open={session}
                    IconComponent={KeyboardArrowDownIcon}
                    style={{ background: "#fff", width: "136px" }}
                  >
                ...
                <div className={styles.modal_dropDown}>
                  ...
                  <Select
                    ...
                    open={instructor}
                    IconComponent={KeyboardArrowDownIcon}
                    style={{ background: "#fff", width: "229px !important" }}
                  >
                    <MenuItem
                      onClick={() => setInstructor(!instructor)}
                      value={10}
...
export default PatientsDetailsEditAssign;
