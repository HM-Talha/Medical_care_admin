...
export type dailyUpdateListStateType = {
  query: {
    limit: number;
    page: number;
...
export const UserState: dailyUpdateListStateType = {
  query: {
    user_type: "",
    distributorId: "",
    limit: 10,
    ...
    items: [
      {
        ...
        activityName: "Breath Meditation 1",
...
export type ContainerState = dailyUpdateListStateType;
