...
import { IndividualTreatmentItemType, UserState } from "../types";
import set from "lodash/set";
import { FormError } from "app/containers/types";

const initialState = UserState;

export const IndividualTreatmentSlice = createSlice({
  name: "individualTreatmentState",
  initialState,
  reducers: {
    editUser: (state, action: PayloadAction<IndividualTreatmentItemType>) => {
    ...
    updateSuccess(state, action: PayloadAction<IndividualTreatmentItemType>) {
      state.loading = false;
    ...
    handleBlockSuccess: (state, action: PayloadAction<IndividualTreatmentItemType>) => {
      // const index = state.list.items.findIndex(
...
export const { reducer, actions, name: sliceKey } = IndividualTreatmentSlice;
